(function($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    prevImage() { // Sert pour la navigation dans la modal
      ...
      // Construire la collection des images visibles selon le filtre
      ...
      if (activeTag === "all") {
        ...
        $(".item-column").each(function() {
          if (
            $(this).children("img").data("gallery-tag") === activeTag
          ) {
            imagesCollection.push($(this).children("img"));
          }
        });
      ...
      $(imagesCollection).each(function(i) {
        if ($(activeImage).attr("src") === $(this).attr("src")) {
          index = i - 1; // aller à la précédente
        }
      });

      // Si on est au début, revenir à la fin
      if (index < 0) {
